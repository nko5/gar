...
~~~sh
# getting the code
git clone git@github.com:nko5/gar.git && cd ./gar/
...
# deploying to Modulus (to http://gar.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/gar" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
